<main>
    <section class="grid grid-2-col">
        <div class="">
            ...
            <p class="claim">
                An evolving application <span class="hilite">blueprint.</span>
            </p>
            <hr>
            <p class="claim">
                Loom73 is Level73's application blueprint. A foundation of conventions, reusable components and architectural patterns woven from years of real-world development experience.
            </p>
    ...
    <section class="grid grid-25 breakout">
        <div class="card">
            <span class="icon x3 color-accent cube"></span>
            <h2>Built for real projects</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab amet culpa, dignissimos ea enim est hic maxime, mollitia nulla perspiciatis possimus quasi quidem quo recusandae repellat, sint suscipit tempora vel?</p>
        </div>
        <div class="card">
            <span class="icon x3 color-accent layers"></span>
            <h2>MVC at the core</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab amet culpa, dignissimos ea enim est hic maxime, mollitia nulla perspiciatis possimus quasi quidem quo recusandae repellat, sint suscipit tempora vel?</p>
        </div>
        <div class="card">
            <span class="icon x3 color-accent puzzle"></span>
            <h2>Integrated by design</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab amet culpa, dignissimos ea enim est hic maxime, mollitia nulla perspiciatis possimus quasi quidem quo recusandae repellat, sint suscipit tempora vel?</p>
        </div>
        <div class="card">
            <span class="icon x3 color-accent leaf"></span>
    ...
    <section class="grid grid-2-col">
        <div>
            ...
            <hr>
            <p>Loom73 is a blueprint for PHP application development, based on the consolidated MVC architectural model. The various components of the blueprint are namespaced and concern-separated, to allow for a smooth developer experience.</p>
            <p>Loom73 is minimal at its core by design. It ships 2 backend dependencies (DotEnv and PHPMailer). Consolidated and strong libraries, used by many.</p>
            <p>Out of the box you get RBAC access control, but you don't need to stick to it. Loom73 can be easily extended to allow for PBAC, or any other access control model you may want to implement.</p>
        </div>
        <div>
            <figure>
                <img src="/assets/mvc.svg" alt="MVC Diagram" width="512" height="512">
                <figcaption>MVC Diagram</figcaption>
                </figure>
        </div>
    </section>
