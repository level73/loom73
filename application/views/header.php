<header id="main-header" data-responsive-nav>
    ...
    <div class="user-info">
        ...
        <div id="toolbar">
            <button class="button" popovertarget="settings-menu"><span class="sr-only">Settings</span> <i class="stitch stitch--cog"></i></button>
            <a class="button" href="/user/logout"><span class="sr-only">Logout</span> <i class="stitch stitch--logout"></i></a>
        </div>
    </div>
